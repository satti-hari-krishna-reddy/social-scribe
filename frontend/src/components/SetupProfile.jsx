const SetupProfile = ({ open, handleClose }) => {
    ...
    return (
      <Modal open={open} onClose={handleClose}>
        <Box sx={{ width: 400, padding: '2rem', backgroundColor: '#2E2E2E', borderRadius: '12px', color: '#FFFFFF', textAlign: 'center' }}>
          ...
          <TextField
            ...
            fullWidth
            sx={{ marginBottom: 2, backgroundColor: '#3A3A3A', borderRadius: '5px', input: { color: '#FFFFFF' } }}
          />
          <TextField
