...
const About = () => {
  return (
    <Box sx={{ padding: '3rem 2rem', backgroundColor: '#1A1A1A', color: '#FFFFFF' }}>
      ...
      >
        What started as a hackathon idea is now something I continue to work on and improve, even if
        it's just for personal use or to demonstrate what can be built with APIs, automation, and
        AI.
      </Typography>
    </Box>
  );
