    ...
    <div style={{ backgroundColor: "#2E2E2E", minHeight: "100vh", padding: "20px" }}>
      ...
      >
        ...
        <Button
          ...
          sx={{ ml: 0.1, mr: 8,   backgroundColor: "#FF6B6B",
            "&:hover": { backgroundColor: "#e05555" }, }} // Added a bit of left margin     
        >
          Log Out
        </Button>
        <Button
...
>
  ...
  >
    ...
    <Typography
      ...
      sx={{ mt: 2, color: "#CCCCCC" }}
    >
      Are you sure you want to delete your account? This action is
      irreversible, and all your data will be permanently erased.
    </Typography>
    <TextField
